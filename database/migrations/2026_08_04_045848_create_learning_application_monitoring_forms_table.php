...
return new class extends Migration
{
    ...
    {
        Schema::create('learning_application_monitoring_forms', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('core_monitoring', function (Blueprint $table) {
            $table->id();
            $table->foreignId('learning_application_monitoring_form_id')->constrained('learning_application_monitoring_forms')->onDelete('cascade');
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists('learning_application_monitoring_forms');
    }
};
